...
INSERT INTO transactions (type, amount, description, transaction_date, account_id, category_id, user_id, logged_by_user_id) VALUES
...
('income', 5000.00, 'Monthly Salary - Current Month', generate_transaction_date(0), 
 ...
 (SELECT user_id FROM accounts WHERE name = 'Primary Checking' LIMIT 1),
 (SELECT user_id FROM accounts WHERE name = 'Primary Checking' LIMIT 1)),
...
('income', 450.00, 'Stock Dividends Q1', generate_transaction_date(0, 28),
 ...
 (SELECT user_id FROM accounts WHERE name = 'Stock Portfolio' LIMIT 1),
 (SELECT user_id FROM accounts WHERE name = 'Stock Portfolio' LIMIT 1)),
...
('income', 125.00, 'Crypto Staking Rewards', generate_transaction_date(0, 1),
 ...
 (SELECT id FROM categories WHERE name = 'Investment Returns' AND type = 'income' LIMIT 1),
 (SELECT user_id FROM accounts WHERE name = 'Crypto Wallet' LIMIT 1),
 (SELECT user_id FROM accounts WHERE name = 'Crypto Wallet' LIMIT 1)),
...
('expense', 45.00, 'Lunch with Colleagues', generate_transaction_date(0, 22),
 ...
 (SELECT user_id FROM accounts WHERE name = 'Main Credit Card' LIMIT 1),
 (SELECT user_id FROM accounts WHERE name = 'Main Credit Card' LIMIT 1)),
...
('expense', 200.00, 'Clothing Shopping', generate_transaction_date(0, 8),
 ...
 (SELECT user_id FROM accounts WHERE name = 'Rewards Credit Card' LIMIT 1),
 (SELECT user_id FROM accounts WHERE name = 'Rewards Credit Card' LIMIT 1)),
...
INSERT INTO transactions (type, amount, description, transaction_date, from_account_id, to_account_id, user_id, logged_by_user_id) VALUES
