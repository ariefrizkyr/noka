-- FINAL FIX: Replace UPDATE exception with proper UPDATE handling
-- This migration ensures UPDATE support by running LAST (zzz prefix)
...
BEGIN
    ...
    ELSIF TG_OP = 'UPDATE' THEN
        ...
        -- REPLACED EXCEPTION WITH PROPER HANDLING!
...
-- Add comment to document this FINAL fix
COMMENT ON FUNCTION update_account_balance_with_ledger() IS 'FINAL ULTIMATE VERSION: Handles account balance updates for transaction INSERT, UPDATE, and DELETE operations. UPDATE operations reverse old transaction effects and apply new ones. This version DEFINITELY overrides the exception-throwing UPDATE handler.';