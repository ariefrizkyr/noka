-- ULTIMATE FINAL FIX: This migration has timestamp 23:00:00 to ensure it runs LAST
-- Replace UPDATE exception with proper UPDATE handling once and for all
...
BEGIN
    ...
    ELSIF TG_OP = 'UPDATE' THEN
        -- *** THIS IS THE FIX *** Handle UPDATE operations properly instead of throwing exception
...
-- Add comment to document this ULTIMATE final fix
COMMENT ON FUNCTION update_account_balance_with_ledger() IS 'ULTIMATE FINAL VERSION (23:00:00): Handles UPDATE operations properly without throwing exceptions. This definitively replaces any earlier versions that had RAISE EXCEPTION for UPDATE.';